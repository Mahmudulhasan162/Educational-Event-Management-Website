    ...
    <section className="bg-gray-100 py-16">
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-4 text-gray-800"><span className="text-[#075E54]">About</span> Us</h2>
          <p className="text-gray-600 leading-relaxed w-2/3 text-center border-4 border-[#075E54] p-6 text-lg font-medium mx-auto">
