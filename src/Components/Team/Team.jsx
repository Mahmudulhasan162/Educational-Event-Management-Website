    ...
    return (
        <div className="p-16 text-center">
            ...
            <div className="flex my-10 space-x-10">
                ...
                <div>
                <img className="relative inline-block h-[200px] w-[200px] rounded-full border-4 border-[#075E54] object-cover object-center" src="https://i.ibb.co/dJsTwVh/ezgif-com-gif-maker-1.jpg" alt="" />
                ...
                <div>
                <img className="relative inline-block h-[200px] w-[200px] rounded-full border-4 border-[#075E54] object-cover object-center" src="https://i.ibb.co/3TknGPF/p2.jpg" alt="" />
                ...
                <div>
                <img className="relative inline-block h-[200px] w-[200px] rounded-full border-4 border-[#075E54] object-cover object-center" src="https://i.ibb.co/ygw72Yt/p3.jpg" alt="" />
