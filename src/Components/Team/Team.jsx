    ...
    return (
        <div className="p-16 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 my-10 space-x-10">
                ...
                <h2 className="text-2xl my-3 font-semibold dark:text-white">Allen Garfield</h2>
                <h2 className="text-sm  font-semibold text-slate-600 dark:text-white">MANAGER</h2>
                </div>
                <div>
                ...
                <h2 className="text-2xl my-3 font-semibold dark:text-white">Martha Nielsen</h2>
                <h2 className="text-sm font-semibold text-slate-600 dark:text-white">AGENCY FOUNDER</h2>
                </div>
                <div>
                ...
                <h2 className="text-2xl my-3 font-semibold dark:text-white">Gina Stiebitz</h2>
                <h2 className="text-sm  font-semibold text-slate-600 dark:text-white">COORDINATOR</h2>
                </div>
                <div>
                ...
                <h2 className="text-2xl my-3 font-semibold dark:text-white">Louis Hoffman</h2>
                <h2 className="text-sm font-semibold text-slate-600 dark:text-white">CREATIVE DIRECTOR</h2>
                </div>
            </div>
