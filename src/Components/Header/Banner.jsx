const Banner = () => {
  ...
  <div id="slide1" className="h-[400px] carousel-item relative w-full text-center"  style={{backgroundImage: `linear-gradient(rgba(0, 0,0, 0.7), rgba(18, 140, 126, 0.7)),url('https://i.ibb.co/mbS8db5/Education.jpg')`,backgroundSize: 'cover', backgroundPosition: 'center',}}>
    <div style={{opacity: '100%'}} className="flex flex-col justify-center items-center mx-auto">
            <p className="text-5xl font-bold mb-10 text-white"> Skills For Tomorrow :</p>

            <p className="text-4xl font-semibold text-white text-center">Join Webinars, Career Fair, Training Programs</p>
            </div>
  ...
  <div style={{opacity: '100%'}} className="flex flex-col justify-center items-center mx-auto">
            <p className="text-5xl mb-10 font-bold text-white text-center">Educational Excellence :
            </p> 
            <p className="text-4xl font-semibold text-white text-center">Immense Yourself in Insightful Conferences </p>
            </div>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  ...
  <div id="slide3" className="carousel-item relative w-full" style={{backgroundImage: `linear-gradient(rgba(0, 0,0, 0.7), rgba(18, 140, 126, 0.7)),url('https://i.ibb.co/kDSfDch/995x664-17-1188-CAREER-003.png')`,backgroundSize: 'cover', backgroundPosition: 'center',}}>
    <div style={{opacity: '100%'}} className="flex flex-col justify-center items-center mx-auto">
            <p className="text-5xl mb-10 font-bold text-white text-center">Unlock Your Career Potential :
            </p> 
            <p className="text-4xl font-semibold text-white text-center">Navigate Our Dynamic Career Fairs</p>
            </div>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide2" className="btn btn-circle">❮</a> 
      <a href="#slide4" className="btn btn-circle">❯</a>
  ...
  <div style={{opacity: '100%'}} className="flex flex-col justify-center items-center mx-auto">
            <p className="text-5xl font-bold mb-10 text-white text-center">Career Fair Brilliance : <br />
            </p>
            <p className="text-4xl font-semibold text-white text-center">Forge Connections for Future Success</p>
            </div>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
