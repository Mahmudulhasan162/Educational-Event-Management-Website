...
const Login = () => {
  ...
  <div className="p-6 pt-0">
    ...
    <button onClick={handleGoogleLogIn}
      className=" my-4 block w-full select-none rounded-lg bg-gradient-to-tr from-[#075E54] to-[#25D366] py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
      type="button"
      data-ripple-light="true"
    >
      Sign In with Google
